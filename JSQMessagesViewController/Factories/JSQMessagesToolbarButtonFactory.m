...
{
    UIImage *accessoryImage = [UIImage imageNamed:@"icon_smart-keyboard"];
//    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor lightGrayColor]];
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
//    accessoryButton.titleEdgeInsets = UIEdgeInsetsMake(0, 10, 5, 15);
    accessoryButton.imageEdgeInsets = UIEdgeInsetsMake(5, 12.5, 5, 12.5);
...
{
    UIImage *accessoryImage = [UIImage imageNamed:@"icon_keyboard"];
    //    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor lightGrayColor]];
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
    
    UIButton *accessoryButton = [[UIButton alloc] initWithFrame:CGRectMake(0.0f, 7.0f, accessoryImage.size.width *.975, accessoryImage.size.height * .2)];
    [accessoryButton setImage:accessoryImage forState:UIControlStateNormal];
    [accessoryButton setImage:highlightedImage forState:UIControlStateHighlighted];
...
//    accessoryButton.contentMode = UIViewContentModeScaleAspectFit;
    ...
    accessoryButton.tintColor = [UIColor lightGrayColor];
    accessoryButton.translatesAutoresizingMaskIntoConstraints = NO;
    accessoryButton.imageEdgeInsets = UIEdgeInsetsMake(5, 12.5, 7, 5);
    return accessoryButton;
}
@end
