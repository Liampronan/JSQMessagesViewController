...
//        if (!hasText){
//             self.contentView.rightBarButtonItemNoText = [UIButton buttonWithType:UIButtonTypeSystem];
//            [self.contentView.rightBarButtonItemNoText setTitle:@"yi" forState:UIControlStateNormal];   
//        }
    }
    else {
